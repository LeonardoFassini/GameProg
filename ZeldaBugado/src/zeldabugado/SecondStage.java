...
public class SecondStage
{
    ...
    public SecondStage(BackGround backGround, Window window, Keyboard keyboard, Mouse mouse)
    {
    ...
    {
        backGround.setBackGround("bg2.png");
    ...
    public void loop(BackGround backGround, Window window, Keyboard keyboard, Mouse mouse)
    {
        while (gameGoing == true)
        {
            ...
            boneco.verifyFloor(boneco, window, 537, 79, floor);
